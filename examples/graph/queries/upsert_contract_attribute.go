...
const upsertContractAttributeSQL = `
...
func (q *Queries) UpsertContractAttribute(ctx context.Context, params *UpsertContractAttributeParams) error {
	_, err := q.db.Exec(ctx, upsertContractAttributeSQL, params.ChainID, params.ContractAddress, params.TokenID, params.ScopeAddress, params.Name, params.Value, params.BlockNumber)
	return err
}
